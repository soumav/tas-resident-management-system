...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      <div className="space-y-4 mb-8">
        {groups.length > 0 ? groups.map(group => (
          ...
          <div className="text-center py-8 bg-gray-50 rounded-lg">
            <ListIcon className="h-12 w-12 mx-auto text-gray-400 mb-2" />
            <h4 className="text-lg font-medium text-gray-700">No Groups Yet</h4>
            <p className="text-gray-500 mb-4">Start by creating your first group</p>
            <Button className="bg-sanctuary-green hover:bg-sanctuary-light-green" onClick={openAddGroupDialog}>
      ...
      <Dialog open={isAddGroupDialogOpen} onOpenChange={setIsAddGroupDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Create a new group for organizing residents.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <label htmlFor="groupDescription" className="text-sm font-medium">Description (Optional)</label>
              <Input
                id="groupDescription"
      ...
      <Dialog open={isEditGroupDialogOpen} onOpenChange={setIsEditGroupDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <label htmlFor="editGroupDescription" className="text-sm font-medium">Description (Optional)</label>
              <Input
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the group "{selectedGroup?.name}"? This will also delete all associated subgroups. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      {/* Dialog for adding a new subgroup */}
      <Dialog open={isAddSubgroupDialogOpen} onOpenChange={setIsAddSubgroupDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Add New Subgroup</DialogTitle>
            <DialogDescription>Create a new subgroup for organizing residents within a group.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <label htmlFor="subgroupName" className="text-sm font-medium">Subgroup Name</label>
              <Input
                id="subgroupName"
            ...
            <div className="space-y-2">
              <label htmlFor="subgroupDescription" className="text-sm font-medium">Description (Optional)</label>
              <Input
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAddSubgroup} disabled={!newSubgroupName.trim()}>Add Subgroup</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      
      {/* Dialog for editing a subgroup */}
      <Dialog open={isEditSubgroupDialogOpen} onOpenChange={setIsEditSubgroupDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit Subgroup</DialogTitle>
            <DialogDescription>Update the details for this subgroup.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <label htmlFor="editSubgroupName" className="text-sm font-medium">Subgroup Name</label>
              <Input
                id="editSubgroupName"
                placeholder="Enter subgroup name..."
                value={newSubgroupName}
            ...
            <div className="space-y-2">
              <label htmlFor="editSubgroupDescription" className="text-sm font-medium">Description (Optional)</label>
              <Input
      ...
      {/* Dialog for confirming subgroup deletion */}
      ...
      {/* Dialog for confirming resident deletion */}
      ...
      {/* Dialog for editing a resident */}
      <Dialog open={isEditResidentDialogOpen} onOpenChange={setIsEditResidentDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Edit Resident</DialogTitle>
            <DialogDescription>Update the details for {selectedResident?.name}.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              <label htmlFor="editResidentName" className="text-sm font-medium">Name</label>
              <Input
                id="editResidentName"
            ...
            <div className="space-y-2">
              <label htmlFor="editResidentDescription" className="text-sm font-medium">Description (Optional)</label>
              <Input
                id="editResidentDescription"
                placeholder="Enter description..."
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Arrival Date (Optional)</label>
              <Popover>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setEditResidentData({...editResidentData, group_id: newGroupId, subgroup_id: null});
                }}
              >
            ...
            {editResidentData.group_id !== null && groups.find(g => g.id === editResidentData.group_id)?.subgroups?.length > 0 && (
              <div className="space-y-2">
                <label className="text-sm font-medium">Subgroup (Optional)</label>
                <select
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  value={editResidentData.subgroup_id || ''}
                  onChange={(e) => setEditResidentData({...editResidentData, subgroup_id: e.target.value ? Number(e.target.value) : null})}
                >
            ...
            <div className="space-y-2">
              ...
              {previewUrl && (
                <div className="mt-2 border rounded-md overflow-hidden h-48 flex items-center justify-center">
                  <img 
                    src={previewUrl} 
                    alt="Preview" 
